...
export const MOLECULES: Record<string, MoleculeConfig> = {
  H2O: {
    ...
    hints: [
      ...
      ['混成軌域', 'sp³（四個 sp³ 軌域：2 鍵結 + 2 孤對）'], ['極性', '極性分子'],
    ],
  ...
  BF3: {
    ...
    hints: [
      ...
      ['理論鍵角', '120°'], ['混成軌域', 'sp²（3 個 sp² 軌域各與 F 形成 σ 鍵，空 p 軌域垂直分子面）'], ['極性', '非極性分子'],
    ],
  ...
  CO2: {
    ...
    hints: [
      ...
      ['理論鍵角', '180°'], ['混成軌域', 'sp（2 個 sp 軌域形成 σ 鍵，2 個 p 軌域形成 π 鍵與 O 各成雙鍵）'], ['極性', '非極性分子'],
    ],
  ...
  CH4: {
    ...
    hints: [
      ...
      ['理論鍵角', '109.5°'], ['混成軌域', 'sp³（4 個等能 sp³ 軌域指向四面體四頂點）'], ['極性', '非極性分子'],
    ],
